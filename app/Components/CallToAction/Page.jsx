        ...
        <div className="flex lg:flex-row flex-col justify-between items-center">
            <div>
                ...
                <div className="flex gap-5 items-center lg:justify-normal justify-center mt-7">
                    <Image src="/google.png" width={120} height={120} alt="Google Image"/>
                    <Image src="/apple.png" width={110} height={110} alt="Apple Image"/>
                </div>
            </div>
            <div className="z-10 lg:-mr-10 lg:mt-0 mt-5 mr-10">
                <Image src="/phone.png" width={750} height={750} alt="Phone Image"/>
            </div>
        </div>
    </main>
  )
